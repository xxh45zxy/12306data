...
def railwaycomminvoicedata(file_name,check_id,sort_id,input_type,*input_json_data):
                            ...
                            if value == []:
                                ...
                                for value_s in value:
                                    ...
                                    for key_t, value_t in value_s.items():
                                        key_ts = "batchList_" + str(value_seq) + "_" + key_t
                                        if value_t is None:
                                            order_new[key_ts] = ""
                                        else:
...
if __name__ == '__main__':
    ...
    file_name_1 = "railwaycomminvoice.csv"
    check_id_1 = "orderId"
    sort_id_1 = "saleTime"

    railwaycomminvoicedata(file_name_1,check_id_1,sort_id_1,1)
