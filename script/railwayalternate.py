...
def railwayalternatedata(file_name,check_id,sort_id,input_type,*input_json_data):
...
if __name__ == '__main__':
    ...
    file_name_1 = "railwayalternate.csv"
    check_id_1 = "reserve_no"
    sort_id_1 = "trace_id"

    railwayalternatedata(file_name_1,check_id_1,sort_id_1,1)
