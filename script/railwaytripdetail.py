...
def railwaytripdetaildata(file_name,check_id,sort_id,input_type,*input_json_data):
    ...
    while True:
        ...
        try:  
            ...
            # 遍历orderList中的每个项目
            for order_b in data.values():
                
                order_s = order_b["data"]["data"]
    ...
    save_csv(file_name,check_id,sort_id,existing_data,all_new_data,1)


if __name__ == '__main__':
    
    file_name_1 = "railwaytripdetail.csv"
    check_id_1 = ""
    sort_id_1 = "operate_time"

    railwaytripdetaildata(file_name_1,check_id_1,sort_id_1,1)
