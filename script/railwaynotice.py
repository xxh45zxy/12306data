...
def railwaynoticedata(file_name,check_id,sort_id,input_type,*input_json_data):
    ...
    while True:
        ...
        try:  
            ...
            for order_b in data.values():
                ...
                if "data" in order_b:
                    order = order_b["data"]["itinerary_notice"]["psr"]
                    order_new = {}
...
if __name__ == '__main__':
    ...
    file_name_1 = "railwaynotice.csv"
    check_id_1 = "ext_ticket_no"
    sort_id_1 = "local_start_time"

    railwaynoticedata(file_name_1,check_id_1,sort_id_1,1)
