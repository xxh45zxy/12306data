...
def read_extno_info(file_path_list):
    extno_info_list = []
        ...
        try:
            with open(file_path, mode='r', encoding='utf-8') as file:
                ...
                for row in csv_reader:
                    ...
                    '''ext_ticket_no_1 = row.get('tickets_0_ext_ticket_no')
                    if ext_ticket_no_1:
                        extno_info_list.append(ext_ticket_no_1)
                    ext_ticket_no_2 = row.get('tickets_1_ext_ticket_no')
                    if ext_ticket_no_2:
                        extno_info_list.append(ext_ticket_no_2)'''
...
if __name__ == "__main__":
    ...
    extno_info = read_extno_info(file_path_list)
    print(extno_info)
