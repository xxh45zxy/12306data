...
if __name__ == '__main__':
    ...
    file_name_1 = "railwayalternateapp.csv"
    check_id_1 = "reserve_no"
    sort_id_1 = "trace_id"
...
AlipayJSBridge.call('rpcWithBaseDTO', {
  "headers":{},"httpGet":false,"signType":-1,"requestData":[{"_requestBody":{"pageNo":0,"pageSize":100,"queryStartDate":"20000101","queryEndDate":"20991231","hbVersion":""}}],"operationType":"com.cars.otsmobile.afterNate.queryPayedOrder"
}, function(result) {
  console.log(result);
});
