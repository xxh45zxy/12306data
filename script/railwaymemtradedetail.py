...
def railwaymemtradedetaildata(file_name,check_id,sort_id,input_type,*input_json_data):
    ...
    while True:
        ...
        try:  
            ...
            # 遍历orderList中的每个项目
            for order_0 in data.values():

                if 'data' in order_0:

                    order = order_0['data'][0]
                    order_new = {}
...
if __name__ == '__main__':
    ...
    file_name_1 = "railwaymemtradedetail.csv"
    check_id_1 = "trade_id"
    sort_id_1 = "train_date"

    railwaymemtradedetaildata(file_name_1,check_id_1,sort_id_1,1)
